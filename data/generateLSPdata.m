function generateLSPdata()

%dowload LSP data and annotation(http://www.comp.leeds.ac.uk/mat4saj/lsp.html)
...
storeFMtTrain=[rootPth '%s_imdbsT%daug%d.mat'];
storeFMtVal=[rootPth '%s_imdbsV%daug%d.mat'];
storeFMtMAD=[rootPth '%s_mad%daug%d.mat'];
